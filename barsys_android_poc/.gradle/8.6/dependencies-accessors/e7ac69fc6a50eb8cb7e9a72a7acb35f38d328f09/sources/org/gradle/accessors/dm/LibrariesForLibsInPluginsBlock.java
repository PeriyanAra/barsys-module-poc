...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final FlutterVersionAccessors vaccForFlutterVersionAccessors = new FlutterVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.flutter</b>
         */
        public FlutterVersionAccessors getFlutter() {
            return vaccForFlutterVersionAccessors;
        }

    }

    public static class FlutterVersionAccessors extends VersionFactory  {

        public FlutterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>flutter.debug</b> with value <b>1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDebug() { return getVersion("flutter.debug"); }
